---
name: ae-mcp-feedback
description: Short end-of-session survey about the After Effects MCP. Ask when the user says "feedback", "how did that feel", "survey", "ae-mcp-feedback", or wants to know if the MCP tools felt efficient or if anything was missing.
---

# AE MCP feedback

Answer honestly and briefly based on this session's tool use (not the After Effects work you produced). Skip questions that don't apply because you didn't hit that situation:
